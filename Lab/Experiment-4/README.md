...
Flask==2.3.3
```
![Create Requirment](./Images/4.png)
...
CMD ["python", "app.py"]
```
![Create DockerFile](./Images/5.png)
...
```
![Tagging Existing Image](./Images/12.png)
...
```
![Create DockerFile](./Images/16.png)
...
```
![Test Application](./Images/17.png)
...
```
![Remove Container](./Images/22.png)
...
CMD ["python", "app.py"]
```
![Create DockerFile](./Images/24.png)
...
```
![Build Regular Image](./Images/26.png)
...
```
![Build Multi-Stage Image](./Images/27.png)
...
```
![Create DockerFile](./Images/28.png)
...
```
![Push 1.0 Tag Image](./Images/31.png)

**Step-30:- Push Latest Image**
```bash
docker push username/my-flask-app:latest
```
![Push Image](./Images/32.png)
...
```
![Create app.js](./Images/36.png)
![Create app.js](./Images/37.png)
...
```
![Create package file](./Images/38.png)
![Create package file](./Images/39.png)
...
CMD ["node", "app.js"]
```
![Create DockerFile](./Images/40.png)
![Create DockerFile](./Images/41.png)
...
```
![Create DockerFile](./Images/44.png)
