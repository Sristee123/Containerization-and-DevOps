...
```
![Build from Ubuntu Image](./Images/7.png)
...
```
![List Ubuntu-Images](./Images/9.png)
...
CMD ["nginx", "-g", "daemon off;"]
```
![Create dockerfile](./Images/10.png)
![Create dockerfile](./Images/11.png)
...
```
![Build Alpine-Image](./Images/12.png)
...
```
![List Alpine-Images](./Images/14.png)
...
```
![List All nginx Images](./Images/15.png)
...
```
![Serve Custome HTML](./Images/17.png)
![Serve Custome HTML](./Images/18.png)
