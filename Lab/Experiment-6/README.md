...
node:18-alpine
```
![Run Node Conrtainer](./Images/13.png)
...
docker-compose ps
```
![Start Node Services](./Images/15.png)
...
```
![Remove Network & Container](./Images/21.png)
...
docker-compose ps
```
![Start Services](./Images/29.png)
![Start Services](./Images/30.png)
